(function() {
    angular.module("webfront", ["ngRoute"]).config(function($routeProvider, $interpolateProvider, $provide, $locationProvider) {
        ...
        $routeProvider
            ...
            .when("/about-aquaponics", {
                templateUrl: "/templates/about-aquap.html"
            })
